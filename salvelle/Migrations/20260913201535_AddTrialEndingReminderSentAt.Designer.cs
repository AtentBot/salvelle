...
namespace Migrations
{
    ...
    [Migration("20260913201535_AddTrialEndingReminderSentAt")]
    partial class AddTrialEndingReminderSentAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Core.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Estabelecimento autorizado pela ANVISA para manipula��o magistral e oficinal conforme RDC 67/2007",
                            IsActive = true,
                            Name = "Farm�cia de Manipula��o",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Estabelecimento comercial de dispensa��o e com�rcio de medicamentos industrializados",
                            IsActive = true,
                            Name = "Drogaria",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Estabelecimento que combina dispensa��o de medicamentos industrializados e manipula��o magistral",
                            IsActive = true,
                            Name = "Farm�cia com Manipula��o",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Empresa autorizada para armazenamento e distribui��o de medicamentos e insumos farmac�uticos",
                            IsActive = true,
                            Name = "Distribuidora",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Estabelecimento especializado em manipula��o e dispensa��o de medicamentos homeop�ticos",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Estabelecimento destinado � realiza��o de an�lises cl�nicas e controle de qualidade",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Unidade destinada exclusivamente � dispensa��o de medicamentos industrializados",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Estabelecimento de dispensa��o de plantas medicinais e fitoter�picos",
                            IsActive = true,
                            Name = "Ervan�ria",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
            ...
            modelBuilder.Entity("Models.PendingTwoFactorSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("pending_two_factor_sessions");
                });
            ...
            modelBuilder.Entity("Models.RevokedJwt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Models.Subscription", b =>
                {
                    ...
                    b.Property<DateTime?>("TrialEndingReminderSentAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("trial_ending_reminder_sent_at");
            ...
            modelBuilder.Entity("Models.SubscriptionCancellation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("CanceledByEmployeeId")
                        .HasColumnType("uuid")
                        .HasColumnName("canceled_by_employee_id");
                    ...
                    b.ToTable("subscription_cancellations");
                });
            ...
            modelBuilder.Entity("Models.Support.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("IsAutoResolvable")
                        .HasColumnType("boolean")
                        .HasColumnName("is_auto_resolvable");
            ...
            modelBuilder.Entity("Models.Support.SupportTicketMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Models.Support.WhatsAppInstanceStatus", b =>
                {
                    ...
                    b.Property<Guid?>("ActiveTicketId")
                        .HasColumnType("uuid")
                        .HasColumnName("active_ticket_id");

                    b.Property<DateTime?>("DisconnectedSince")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("disconnected_since");
                    ...
                    b.ToTable("whatsapp_instance_status");
                });
            ...
            modelBuilder.Entity("Models.Support.SupportTicketMessage", b =>
                {
                    b.HasOne("Models.Support.SupportTicket", "Ticket")
                        .WithMany("Messages")
