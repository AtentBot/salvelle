...
public class SngpcService
{
        ...
        Guid employeeId)
    {
        ...
        try
        {
            ...
            return (true, "Movimenta��o registrada com sucesso", movement);
        }
        catch (Exception ex)
        {
            await transaction.RollbackAsync();
            return (false, $"Erro ao registrar movimenta��o: {ex.Message}", null);
        }
        });
    }
        ...
        Guid employeeId)
    {
        try
        {
            ...
            {
                // Calcular movimenta��es do per�odo
            ...
            await _context.SaveChangesAsync();
            return (true, $"{balances.Count} balan�o(s) gerado(s) com sucesso", balances);
        }
        catch (Exception ex)
        {
            return (false, $"Erro ao gerar balan�os: {ex.Message}", new List<ControlledSubstanceBalance>());
        }
    }
        ...
        Guid employeeId)
    {
        ...
        if (balance == null)
            return (false, "Balan�o n�o encontrado");

        if (balance.Status == "FECHADO")
            return (false, "Balan�o j� est� fechado");
        ...
        await _context.SaveChangesAsync();
        return (true, "Balan�o fechado com sucesso");
    }
        ...
        string? controlledList = null)
    {
        ...
        // TODO: Implementar gera��o XML conforme padr�o ANVISA
