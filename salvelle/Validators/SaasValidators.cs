...
public class SignupRequestValidator : AbstractValidator<SignupRequestDto>
{
    ...
    // Delega para a rotina única e centralizada (numérico legado + alfanumérico).
    private bool BeValidCnpj(string? cnpj) => DocumentValidator.IsValidCnpj(cnpj ?? string.Empty);
}
